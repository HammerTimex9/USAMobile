...
// importing openzeppelin's interface for ERC20 tokens
...
contract Benjamins is Ownable, ERC20, Pausable, ReentrancyGuard {
  ...
  constructor() ERC20("Benjamins", "BNJI") {
    ...
    feeReceiver = 0xE51c8401fe1E70f78BBD3AC660692597D33dbaFF;   // xxxx todo: set to correct address
  ...
  function withdrawGains(address _receiver, uint256 _amountIn6dec) public onlyOwner {
    ...
    polygonAMUSDC.transfer(_receiver, _amountIn6dec); 
